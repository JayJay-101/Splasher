...
//    private float innerRadius, outerRadius, centerX, centerY;
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint2.setColor(ContextCompat.getColor(context, R.color.gree) - 4);
        ...
        paint.setColor(ContextCompat.getColor(context, R.color.colorAccent) - 4);
        ...
        paint1.setColor(ContextCompat.getColor(context, R.color.das) + 4);
        ...
        paint3.setColor(ContextCompat.getColor(context, R.color.red_main) + 4);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        squareRect2.set(0.25f * measuredDimenson+4, 0.25f * measuredDimenson + 25, 0.85f * measuredDimenson + 500, 0.85f * measuredDimenson + 400);
